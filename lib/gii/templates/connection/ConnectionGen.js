...
var ConnectionGen = (function () {
    ...
    ConnectionGen.prototype._getTypes = function (_testString) {
        var re = /^[a-z0-9 ]$/i;
        var isValid = re.test(_testString);
        return isValid ? _testString : 'any';
    };
    ConnectionGen.prototype._getMethod = function (model) {
        return ((_a = ["\n    /**\n      * ", "['", "']\n      *\n      * ", "\n      *\n      * @params input 'Object' ", "\n      * @return Promise ", "\n      */\n      public ", "(input: ", "): Q.Promise<", "> {\n        return connector.runCall(\n          this.name,\n          '", "',\n          input\n        );\n      }"], _a.raw = ["\n    /**\n      * ", "['", "']\n      *\n      * ", "\n      *\n      * @params input 'Object' ", "\n      * @return Promise ", "\n      */\n      public ", "(input: ", "): Q.Promise<", "> {\n        return connector.runCall(\n          this.name,\n          '", "',\n          input\n        );\n      }"], html(_a, this.name, model.name, model.action, model.inputModel, model.outputModel, model.name, this._getTypes(model.inputModel), this._getTypes(model.outputModel), model.name)));
        var _a;
    };
