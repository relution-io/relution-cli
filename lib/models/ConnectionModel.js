...
var ConnectionModel = (function () {
    ...
    ConnectionModel.prototype.fromJson = function (path) {
        ...
        return this._fileApi.readHjson(path)
            ...
            _this.name = connectionHjson.name;
            _this.connectorProvider = connectionHjson.connectorProvider;
            _this.description = connectionHjson.description;
            _this.protocol = connectionHjson.protocol;
            _this.properties = connectionHjson.properties;
            _this.calls = connectionHjson.calls;
            return _this;
        });
    };
    /**
     ...
     */
    ConnectionModel.prototype.addCall = function () {
    };
