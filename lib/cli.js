...
"use strict";
var Versioncheck_1 = require('./utility/Versioncheck');
...
var Debugger_1 = require('./commands/Debugger');
...
// preload done
rxjs_1.Observable.forkJoin(all)
    .flatMap(function () {
    return Versioncheck_1.NpmVersionCheck.check();
})
