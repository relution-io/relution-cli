...
var NpmVersionCheck = (function () {
    ...
    NpmVersionCheck.diffIcon = function () {
        var diff = semverDiff(pkg.version, NpmVersionCheck._pkg.version);
    ...
    NpmVersionCheck._versionCheck = function () {
        ...
        return NpmVersionCheck._pkg.version[0] !== pkg.version ?
            emoji.emojify(NpmVersionCheck.diffIcon() + " " + chalk.yellow(Translation_1.Translation.CLI_OUTDATED(NpmVersionCheck._pkg.version))) :
