...
var Command = (function () {
    ...
    Command.prototype.help = function (asArray) {
        ...
        return rxjs_1.Observable.create(function (observer) {
            ...
            _this.flatCommands().forEach(function (commandName) {
                var color = _this.commandIsDisabled(_this.commands[commandName]) ? 'green' : 'red';
    ...
    Command.prototype.commandIsDisabled = function (command) {
    ...
    Command.prototype.setupCommandsForList = function () {
        ...
        this.flatCommands().forEach(function (command) {
            temp.push({
                ...
                disabled: _this.commandIsDisabled(_this.commands[command])
            });
        });
        return temp;
    };
