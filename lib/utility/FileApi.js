...
var FileApi = (function () {
    function FileApi() {
        ...
        this._hjsonOptions = { keepWsc: true };
    }
    /**
    ...
    FileApi.prototype.readHjson = function (path) {
        ...
        return rxjs_1.Observable.create(function (observer) {
            result.subscribe(function (file) {
                observer.next({ path: path, data: Hjson.parse(file, _this._hjsonOptions) });
            }, function (e) { return console.error(e); }, function () { return observer.complete(); });
        });
    };
    FileApi.prototype.copyHjson = function (org) {
        var c = Hjson.stringify(org, this._hjsonOptions);
    ...
    FileApi.prototype.writeHjson = function (content, fileName) {
        ...
        var result = writeFileAsObservable("" + this.path + fileName + "." + this.hjsonSuffix, Hjson.stringify(content, this._hjsonOptions), this.encode);
        return rxjs_1.Observable.create(function (observer) {
