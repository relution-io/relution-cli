...
var Server = (function (_super) {
    ...
    function Server() {
        ...
        this.commands = {
            ...
            help: {
                description: Translation_1.Translation.LIST_COMMAND('Server')
            },
            quit: {
    ...
    Server.prototype.preload = function () {
        ...
        return rxjs_1.Observable.create(function (observer) {
            _super.prototype.preload.call(_this).subscribe({ complete: function () {
    ...
    Server.prototype.update = function (params) {
        var _this = this;
        this.crudHelper.update(params).subscribe(function () { }, function (e) { return console.error(e); }, function () {
    ...
    Server.prototype.rm = function (id) {
        var _this = this;
        this.crudHelper.rm(id).subscribe(function () { }, function (e) { return console.error(e); }, function () {
            return _super.prototype.home.call(_this);
        });
    };
    /**
    ...
    Server.prototype.add = function (params) {
        var _this = this;
        return this.crudHelper.add(params).subscribe(function () { }, function (e) { return console.error(e); }, function () {
            return _super.prototype.home.call(_this);
        });
    };
    return Server;
