    ...
    Create.prototype.npmInstall = function () {
        ...
        return rxjs_1.Observable.create(function (observer) {
            return exec('npm install', function (error, stdout, stderr) {
                ...
                exec("typings install dt~es6-collections dt~es6-promise dt~backbone dt~q dt~express dt~jquery dt~underscore dt~node dt~serve-static dt~express-serve-static-core --save --global", function (e, dout, derr) {
                    if (e) {
