    ...
    Create.prototype.npmInstall = function () {
        ...
        return rxjs_1.Observable.create(function (observer) {
            return exec('npm install', function (error, stdout, stderr) {
                ...
                exec("typings install dt~es6-collections dt~es6-promise dt~express dt~serve-static dt~express-serve-static-core dt~multer dt~body-parser --save --global", function (e, dout, derr) {
                    if (e) {
