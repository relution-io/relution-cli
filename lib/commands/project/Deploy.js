...
var Deploy = (function () {
    ...
    Deploy.prototype.getServerPrompt = function () {
        this._defaultServer = 'default';
        var prompt = this._copy(this.owner._parent.staticCommands.server.crudHelper.serverListPrompt(this._promptkey, 'list', 'Select a Server'));
    ...
    Deploy.prototype.publish = function () {
        ...
        return this.owner._parent.staticCommands.env.envCollection.getEnvironments()
            ...
            if (_this.owner._parent.staticCommands.env.envCollection.collection.length > 0) {
