    ...
    ApiList.prototype.apiList = function (name) {
        ...
        */
        return this._chooseConnection()
            ...
            .exhaustMap(function (resp) {
            return _this._getConnectionUUid(relutionHjson.uuid, connectionModel.name);
        })
            .exhaustMap(function (resp) {
            ...
            return _this.connection.fileApi.writeFile(template.instance.template, template.instance.name + ".gen.js", _this.connection.rootFolder);
        })
            .do({
            complete: function () {
                return _this.connection.log.info(connectionModel.name + " are updated!");
            }
        });
    };
    return ApiList;
