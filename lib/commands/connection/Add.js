...
var AddConnection = (function () {
    ...
    AddConnection.prototype.add = function () {
        ...
        return this._addConnectionNamePath()
            ...
            return _this.connection.fileApi.writeHjson(_this.connectionModel.toJson(), _this.connectionName, _this.connectionHomeFolder);
        })
            .exhaustMap(function () {
            ...
            template.instance.name = _this.connectionName;
            template.instance.path = path.dirname(_this.connectionModel.name);
            return _this.connection.fileApi.writeFile(template.instance.template, template.instance.name + ".js", _this.connectionHomeFolder);
        })
            .do(function (file) {
