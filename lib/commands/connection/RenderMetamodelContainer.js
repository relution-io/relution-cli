...
var RenderMetamodelContainer = (function () {
    ...
    RenderMetamodelContainer.prototype.create = function () {
        ...
        return this._chooseConnection()
            ...
            return _this.connection.getConnectionMetamodelContainer(connection.containerUuid).map(function (resp) {
                return _this._modelFactory.instance.fromJSON(JSON.stringify(resp));
            });
        })
