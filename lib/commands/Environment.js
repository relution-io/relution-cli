...
var Environment = (function (_super) {
    ...
    function Environment() {
       ...
       */
        this.commands = {
            add: {
                when: function () {
                    return RxFs_1.RxFs.exist(process.cwd() + "/env/");
                },
                why: function () {
                    return _this.i18n.FOLDER_NOT_EXIST(process.cwd() + "/env/");
                },
    ...
    Environment.prototype.preload = function () {
        ...
        return _super.prototype.preload.call(this)
            ...
            return _this.envCollection.getEnvironments();
        });
    };
    ...
    Environment.prototype.envExists = function () {
        if (!RxFs_1.RxFs.exist(process.cwd() + "/env/")) {
            return false;
        }
