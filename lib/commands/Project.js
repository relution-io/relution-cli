...
var Project = (function (_super) {
    ...
    function Project() {
        ...
        this.commands = {
            ...
            deploy: {
                ...
                when: function () {
                    if (!RxFs_1.RxFs.exist(path.join(process.cwd(), 'relution.hjson')) || _this._parent.staticCommands.env.envCollection.collection.length <= 0) {
                        return false;
                    }
                    return true;
                },
                why: function () {
                    ...
                    if (_this._parent.staticCommands.env.envCollection.collection.length <= 0) {
                        return _this.i18n.ENV_ADD_FIRSTLY;
                    }
                },
                vars: {
                    name: {
    ...
    Project.prototype.deploy = function () {
        return new Deploy_1.Deploy(this).publish();
    };
    return Project;
}(Command_1.Command));
