...
var Relution = (function (_super) {
    ...
    Relution.prototype.init = function (args) {
        ...
        if (subcommand.length) {
            ...
            return this.showCommands().subscribe(function (answer) {
                console.log(JSON.stringify(answer, null, 2));
                console.log(answer[_this.name]);
                var subcommand = _this.isSubcommand([answer[_this.name]]);
                console.log(subcommand);
                if (subcommand.length) {
                    return _this.subCommand([], subcommand).subscribe(function (response) {
                    ...
                    _this[answer[_this.name]]().subscribe(function () {
                        _this.rl.prompt();
                    });
                }
            });
            ...
            return this.showCommands().subscribe(function () {
                _this.rl.prompt();
            });
        }
    };
